...
data = {"sql": "select rsvp_guest.first_name, rsvp_guest.last_name, meal_choice.meal_description from rsvp_guest JOIN meal_choice on rsvp_guest.meal_choice_rowid = meal_choice.rowid WHERE rsvp_guest.meal_choice_rowid is not NULL ORDER BY rsvp_guest.last_name, rsvp_guest.first_name;"}
